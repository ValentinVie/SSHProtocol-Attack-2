...
#ifdef D4
void digest_message2(const unsigned char *message, size_t message_len, unsigned char **digest, unsigned int *digest_len)
{
	EVP_MD_CTX *mdctx;
...
#ifdef D3
int hmac_message2(unsigned char* msg, size_t mlen, unsigned char** val, size_t* vlen, unsigned char *key)
{
	HMAC_CTX ctx;
	const EVP_MD* md = NULL;
...
#ifdef D5
int rsa_encrypt2(unsigned char *msg, unsigned int msgLen, unsigned char **encMsg, unsigned char **ek,
...
#ifdef D6
int rsa_encrypt3(unsigned char *msg, unsigned int msgLen, unsigned char **encMsg, unsigned char **ek,
	       unsigned int *ekl, unsigned char **iv, unsigned int *ivl, EVP_PKEY *pubkey) 
{
	unsigned int encMsgLen = 0;
	unsigned int blockLen  = 0;
